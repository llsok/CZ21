...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY  (`ciid`),
  KEY `pid` (`pid`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `product` (`pid`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'w', 'a', '悟空', 'song@foxmail.com', '13283718600', '男', '1', null, '天子脚下');
INSERT INTO `user` VALUES ('2', 'b', 'a', '八戒', 'song@shop.com', '13283710000', '男', '1', '833669b614f84c17b95ac2d6e931c5d8', '大明湖畔');
INSERT INTO `user` VALUES ('4', 'n', 'a', '哪吒', 'song@shop.com', '13283710000', '男', '1', '6361ee3818cd46f8ba659854a0feb33e', '南山山顶');
